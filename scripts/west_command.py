...
one-framework west extension in the repository.'''

from west.commands import WestCommand  # your extension must subclass this
from west import log  # use this for user output


class OFWestCommand(WestCommand):

    def __init__(self):
        super().__init__(
            'of-west-command',  # gets stored as self.name
            'one-framework west extension command',  # self.help
            # self.description:
            '''\
A multi-line description of west-command.
